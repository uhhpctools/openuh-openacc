...
enum ST_ACC_TYPE
{
ST_ACC_TYPE_KERNELS_FUNC = 1,		//CUDA kernel function
ST_ACC_TYPE_CONST_VAR = 2,	//CUDA const variables
ST_ACC_TYPE_DEVICE_VAR = 3,	//CUDA device function/variables
ST_ACC_TYPE_SHARED_VAR = 4,	//CUDA shared variables
ST_ACC_TYPE_SHARED_ARRAY = 5,	//CUDA shared variables, a[]
ST_ACC_TYPE_SHARED_ARRAY_FIXED = 6,	//CUDA shared variables, a[111]
ST_ACC_TYPE_SHARED_DEVICE_FUNC = 7,
};

enum ST_ACC_FLAGS
{
    ST_IS_ACC_SHARED_ARRAY	= 0x00000001,	// extern __shared__ xxx sdata[];
    ST_IS_ACC_SHARED_SCALAR_VAR	= 0x00000002,	// extern __shared__ xxx sdata;
    ST_IS_ACC_KERNELS_FUNC = 0x00000004,
    ST_IS_ACC_DEVICE_FUNC = 0x00000008,
    ST_IS_ACC_CONST_VAR = 0x00000010,
    ST_IS_ACC_CONST_ARRAY = 0x00000010,
    // new flags must go into flags_ext field.
}; // ST_FLAGS
#endif
...
#ifdef __UH_OPENACC_1_0    
	mUINT32 acc_flags;		//defined as OpenACC flags
	ST_ACC_TYPE acc_type:8;   //defined as OpenACC types
#endif
...
#define PU_HAS_ACC              0x0040000000000000LL // Symtab has ACC region/do within it
#define	PU_ACC					0x0080000000000000LL // PU is an Kernels/Device Fuction
#define	PU_ACC_LOWER_GENERATED	0x0100000000000000LL // PU generated by acc-lowerer
#define	PU_ACC_ROUTINE			0x0200000000000000LL // PU is an ACC Routine, this function is special, 
													 //both cpu and accelerator have a copy of this function
...
enum FILE_INFO_FLAGS
{
    ...
    FI_HAS_ACC   	= 0x20		// need to process ACC region
};
