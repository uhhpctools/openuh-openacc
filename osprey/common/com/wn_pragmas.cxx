...
WN_PRAGMA_DESC WN_pragmas[] = {
  ...
  { PUSER_MP, WN_PRAGMA_SCOPE_SPECIAL, "MP_IN" },
  { PUSER_MP, WN_PRAGMA_SCOPE_SPECIAL, "MP_OUT" },
	/*******************************OpenACC Pragma ***************************/
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_WAIT" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_UPDATE" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_DECLARE" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CACHE" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_ON, "ACC_PARALLEL_BEGIN" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_OFF, "ACC_PARALLEL_END" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_ON, "ACC_KERNELS_BEGIN" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_OFF, "ACC_KERNELS_END" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_ON, "ACC_DATA_BEGIN" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_OFF, "ACC_DATA_END" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_ON, "ACC_HOSTDATA_BEGIN" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_OFF, "ACC_HOSTDATA_END" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_ON, "ACC_LOOP_BEGIN" },
  { PUSER_ACC, WN_PRAGMA_SCOPE_OFF, "ACC_LOOP_END" },
	
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_IF" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_ASYNC" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_NUM_GANGS" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_NUM_WORKERS" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_VECTOR_LENGTH" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_COPY" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_COPYIN" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_COPYOUT" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_CREATE" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRESENT" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRESENT_OR_COPY" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRESENT_OR_COPYIN" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRESENT_OR_COPYOUT" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRESENT_OR_CREATE" },  
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PARM" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_RESIDENT" },  
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_USE_DEVICE" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_DEVICEPTR" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_COLLAPSE" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_SEQ" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_PRIVATE" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_FIRST_PRIVATE" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_LAST_PRIVATE" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_INOUT_SCALAR" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_VARLIST" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_INTEXP" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_REDUCTION" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_GANG" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_WORKER" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_VECTOR" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_INDEPENDENT" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "WN_PRAGMA_ACC_CLAUSE_DATA_LENGTH" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "WN_PRAGMA_ACC_CLAUSE_DATA_START" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "WN_PRAGMA_ACC_CLAUSE_DATA_END" }, 
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_HOST" },   
  { PUSER_ACC, WN_PRAGMA_SCOPE_SPECIAL, "ACC_CLAUSE_DEVICE" }, 

#ifdef _UH_COARRAYS
  { PUSER_WOPT, WN_PRAGMA_SCOPE_SPECIAL, "DEFER_SYNC" },
  { PUSER_WOPT, WN_PRAGMA_SCOPE_SPECIAL, "SYNC" },
#endif
