...
typedef struct clist_flags {
   ...
   const char *gpu_filename;    /* gpu source code file generated by openacc  */
   const char *gpuh_filename;    /* gpu source code file generated by openacc  */
...
#define CLIST_cuda_filename     Current_CLIST->gpu_filename
#define CLIST_cuda_filename     Current_CLIST->gpuh_filename
