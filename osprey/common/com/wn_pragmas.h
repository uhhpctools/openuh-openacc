...
/* CRAY pragmas */
  ...
  /*OpenACC pragma*/ 
  WN_PRAGMA_ACC_WAIT,
  WN_PRAGMA_ACC_UPDATE,
  WN_PRAGMA_ACC_DECLARE,
  WN_PRAGMA_ACC_CACHE,
  WN_PRAGMA_ACC_PARALLEL_BEGIN,
  WN_PRAGMA_ACC_PARALLEL_END,
  WN_PRAGMA_ACC_KERNELS_BEGIN,
  WN_PRAGMA_ACC_KERNELS_END,
  WN_PRAGMA_ACC_DATA_BEGIN,
  WN_PRAGMA_ACC_DATA_END,
  WN_PRAGMA_ACC_HOSTDATA_BEGIN,
  WN_PRAGMA_ACC_HOSTDATA_END,
  WN_PRAGMA_ACC_LOOP_BEGIN,
  WN_PRAGMA_ACC_LOOP_END,
  /*OpenACC clause*/   
  WN_PRAGMA_ACC_CLAUSE_IF,
  WN_PRAGMA_ACC_CLAUSE_ASYNC,
  WN_PRAGMA_ACC_CLAUSE_NUM_GANGS,
  WN_PRAGMA_ACC_CLAUSE_NUM_WORKERS,
  WN_PRAGMA_ACC_CLAUSE_VECTOR_LENGTH,
  WN_PRAGMA_ACC_CLAUSE_COPY,
  WN_PRAGMA_ACC_CLAUSE_COPYIN,
  WN_PRAGMA_ACC_CLAUSE_COPYOUT,
  WN_PRAGMA_ACC_CLAUSE_CREATE,
  WN_PRAGMA_ACC_CLAUSE_PRESENT,
  WN_PRAGMA_ACC_CLAUSE_PRESENT_OR_COPY,
  WN_PRAGMA_ACC_CLAUSE_PRESENT_OR_COPYIN,
  WN_PRAGMA_ACC_CLAUSE_PRESENT_OR_COPYOUT,  
  WN_PRAGMA_ACC_CLAUSE_PRESENT_OR_CREATE,
  WN_PRAGMA_ACC_CLAUSE_PARM,
  WN_PRAGMA_ACC_CLAUSE_RESIDENT, 
  WN_PRAGMA_ACC_CLAUSE_USE_DEVICE,
  WN_PRAGMA_ACC_CLAUSE_DEVICEPTR,
  WN_PRAGMA_ACC_CLAUSE_COLLAPSE,
  WN_PRAGMA_ACC_CLAUSE_SEQ,
  WN_PRAGMA_ACC_CLAUSE_PRIVATE,  
  WN_PRAGMA_ACC_CLAUSE_FIRST_PRIVATE,  //copy in scalar var
  WN_PRAGMA_ACC_CLAUSE_LAST_PRIVATE, 	//copy out scalar var
  WN_PRAGMA_ACC_CLAUSE_INOUT_SCALAR, 	//in out scalar var
  WN_PRAGMA_ACC_CLAUSE_VARLIST,  
  WN_PRAGMA_ACC_CLAUSE_INTEXP,  
  WN_PRAGMA_ACC_CLAUSE_REDUCTION,  
  WN_PRAGMA_ACC_CLAUSE_GANG,  
  WN_PRAGMA_ACC_CLAUSE_WORKER,  
  WN_PRAGMA_ACC_CLAUSE_VECTOR,  
  WN_PRAGMA_ACC_CLAUSE_INDEPENDENT,
  WN_PRAGMA_ACC_CLAUSE_DATA_LENGTH,
  WN_PRAGMA_ACC_CLAUSE_DATA_START,
  WN_PRAGMA_ACC_CLAUSE_DATA_END,
  WN_PRAGMA_ACC_CLAUSE_HOST,
  WN_PRAGMA_ACC_CLAUSE_DEVICE,    
  /*****************/
#ifdef _UH_COARRAYS
